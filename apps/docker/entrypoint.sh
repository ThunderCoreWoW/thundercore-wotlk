...
CONF_DIR="${CONF_DIR:-/thundercore/env/dist/etc}"
LOGS_DIR="${LOGS_DIR:-/thundercore/env/dist/logs}"
...
# -v == be verbose
cp -rnv /thundercore/env/ref/etc/* "$CONF_DIR"

CONF="$CONF_DIR/$TCORE_COMPONENT.conf"
CONF_DIST="$CONF_DIR/$TCORE_COMPONENT.conf.dist"
