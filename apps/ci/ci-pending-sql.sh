...
UPDATES_PATH="$TC_PATH_ROOT/data/sql/updates/"
...
function import() {
    db=$1
    folder="db_"$db
    pendingPath="$TC_PATH_ROOT/data/sql/updates/pending_$folder"
    updPath="$UPDATES_PATH/$folder"
    archivedPath="$TC_PATH_ROOT/data/sql/archive/$folder/6.x"
